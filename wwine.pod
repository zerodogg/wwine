...
directory that contains a crossover directory.

=item B<-C, --cxg-installdir> I<PATH>

Use the supplied path as the path to a cxgames install directory, or as a
directory that contains a cxgames directory.
